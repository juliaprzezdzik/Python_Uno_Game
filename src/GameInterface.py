...
def draw_player_avatar(backround2, player_num, y_position):
...
def run():
    start_menu()
    game = Game()
    game.start_game(initial_hand_size=3)
    selected_card = None
    is_running = True
    ...
    avatar1 = draw_player_avatar(background_surface, 1, 20)
    avatar2 = draw_player_avatar(background_surface, 0, HEIGHT - 120)
